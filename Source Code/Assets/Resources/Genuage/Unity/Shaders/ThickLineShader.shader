        ...
        SubShader
    {
        Pass
        {
            ...
            void geo(line v2g v[2], inout TriangleStream<g2f> ts)
            {
                ...
                float2 direction = normalize((p2.xy / p2.w) - (p1.xy / p1.w));
                ...
                */
                ...
                float4 offset1 = float4(normal * p1.z * _Thickness / 2.0f, 0, 0);
                float4 offset2 = float4(normal * p2.z * _Thickness / 2.0f, 0, 0);
                //offset1.x *= _ScreenParams.y / _ScreenParams.x;
                //offset2.x *= _ScreenParams.y / _ScreenParams.x;
